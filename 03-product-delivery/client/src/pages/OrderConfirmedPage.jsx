...
const timelineSteps = [
  ...
  { key: 'ready', emoji: '📦', label: 'Pronto para entrega', desc: 'Seu pedido saiu para entrega' },
  { key: 'delivering', emoji: '🚚', label: 'A caminho', desc: 'O entregador está indo até você' },
  ...
  return (
    <div>
      ...
      <GlassCard className={styles.successCard}>
        ...
        <h3 className="h3">Pedido confirmado!</h3>
